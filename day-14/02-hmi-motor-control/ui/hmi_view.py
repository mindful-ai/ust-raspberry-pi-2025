...
from controller.logger import MotorLogger
...
class MotorHMI:
    ...
    def on_speed_change(self, value):
        ...
        MotorLogger.log(f"Speed set to {rpm} RPM")

    def set_direction(self, direction):
        self.controller.set_direction(direction)
        MotorLogger.log(f"Direction set to {direction}")

    def start_motor(self):
        self.controller.start()
        MotorLogger.log("Motor started")
        self.update_status()

    def stop_motor(self):
        self.controller.stop()
        MotorLogger.log("Motor stopped")
        self.update_status()
